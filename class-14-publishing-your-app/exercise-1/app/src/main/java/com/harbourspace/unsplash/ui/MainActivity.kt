...
import com.harbourspace.unsplash.ui.login.LoginActivity
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val preferences = AppPreferences(this).isDarkTheme()
            val isDarkTheme = remember { mutableStateOf(preferences) }
                        ...
                        Row(
                            ...
                            Switch(
                                ...
                                onCheckedChange = {
                                    ...
                                    AppPreferences(this@MainActivity).setForceDarkTheme(it)
                                }
                            )
                        }
                    }
